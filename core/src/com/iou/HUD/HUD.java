...
public class HUD implements Disposable {
    ...
    public float caffeineMeterProgress =0;
    ...
    public HUD(SpriteBatch spriteBatch, PlayScreen the_playScreen){
        ...
        //Drawable textureBar = new TextureRegionDrawable(new TextureRegion(new Texture(Gdx.files.internal("Ui Skins/uiskin.json"))));
        ...
        //caffeineMeter.setPosition(10, IOU.HEIGHT-45);
